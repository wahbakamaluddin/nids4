...
from cicflowmeter_old_knn.writer import output_writer_factory
...
class FlowSession(DefaultSession):
    ...
    def __init__(
        self, output_mode=None, output=None, model_path=None, update_log_widget=None, verbose=False, *args, **kwargs
    ):
        ...
        self.scaler_path = '/home/wahba/Documents/models_anacletu/robust_scaler.joblib'
        self.update_log_widget = update_log_widget
    ...
    def garbage_collect(self, latest_time) -> None:
        ...
        for k in keys:
            ...
            if prediction != "Normal Traffic":
                self.update_log_widget(f"[!!!] Alert! Detected {prediction} traffic from {flow.src_ip}.\n")
