...
from cicflowmeter_knn_xgb_rf1.writer import output_writer_factory
...
class FlowSession(DefaultSession):
    ...
    def __init__(
        self, output_mode=None, output=None, model_path1=None, update_log_widget=None, fields=None, verbose=False, *args, **kwargs
    ):
        ...
        self.model_path2 = '/home/wahba/Documents/nids5/test/model/multi_class/xgb_multi_class.joblib'
        ...
        for k in keys:
            ...
            if self._model1 is not None:
                try:
                    ...
                    model1_prediction = self._model1.predict(X_scaled)[0]
